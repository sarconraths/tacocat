<div class="top">
  ...
  <div class="social-links">
    ...
    <a href="https://www.twitter.com/spacex"><i class="fa fa-twitter"></i></a>
    ...
    <ul>
      ...
      <div class="menu-item_category">
        <a href="pages/about.php">
          ...
          <ul class="nav_second">
            <a href="/pages/infrastruktur.php">
              <li class="menu-item_second">
                IT-Infrastruktur
              </li>
            </a>
            <a href="pages/sicherheit.php">
              <li class="menu-item_second">
                IT-Sicherheit
              </li>
            </a>
      ...
      <div class="menu-item_category">
          <a href="localhost/tacocat/pages/kontakt">
            <li class="menu-item">
              Kontakt
              <i class="fa fa-chevron-down"></i>
            </li>
